...
- PHOENIX_PROJECT_NAME (optional, default "our-rag-project")
...
def _init_tracer():
    project_name = os.getenv("PHOENIX_PROJECT_NAME", "rag-openinference-pydantic-streamlit")
    ...
    return tp.get_tracer("rag-agent")
